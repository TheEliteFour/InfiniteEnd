...
public class InfiniteEndGenerator extends ChunkGenerator {
    ...
    public List<BlockPopulator> getDefaultPopulators(World world) {
        return Arrays.asList((BlockPopulator)new EndPopulator(), new SpirePopulator(), new EndOrePopulator());
    }
